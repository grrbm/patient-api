...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    // Create Weight Loss treatment
    const weightLossTreatmentId = require('uuid').v4();
    await queryInterface.bulkInsert('Treatment', [{
      id: weightLossTreatmentId,
      name: 'Weight Loss',
      userId: userId,
    ...
    console.log('✅ Weight Loss treatment created successfully');
  },

  async down(queryInterface, Sequelize) {
    await queryInterface.bulkDelete('Treatment', { name: 'Weight Loss' }, {});
  }
};